...
namespace RestrictedBoltzmann
{
  class RestrictedBoltzmannProgram
  {
    static void Main(string[] args)
    {
     ...
     // {
     //   int[] computedHidden_test = rbm.HiddenFromVis(trainData[j]);
     //   ShowVector(computedHidden_test, true);
     // }
      ...
      //int[] hiddens = computedHidden;
      int[] computedVisibles = rbm.VisibleFromHid(computedHidden);
      Console.Write("hidden = ");
      ShowVector(computedHidden, false);
      Console.Write("  ->  ");
